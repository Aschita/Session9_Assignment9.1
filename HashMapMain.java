package assignment_9a;          //This java file is inside package named package1 inside src folder.
...
public class HashMapMain        //Class declaration containing main function. 
{
	public static void main(String[] args)        //main function declaration. and because it is static, program execution starts from main function.
	{
		...
		String valueName="Aschita";          //Creating String to map with the key.
